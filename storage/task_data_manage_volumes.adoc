...
NOTE: Les systèmes d'exploitation diffèrent dans leur manière de traiter les volumes clonés.  VMware ESXi traitera un volume cloné comme une copie de volume ou un volume instantané.  Ce volume constituera un périphérique disponible pour créer un nouveau datastore.  Pour plus d'informations sur le montage des volumes clonés et la gestion des LUN de snapshot, consultez la documentation VMware. https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.vsphere.storage.doc/GUID-EEFEB765-A41F-4B6D-917C-BB9ABB80FC80.html["montage d'une copie de banque de données VMFS"] et https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.vsphere.storage.doc/GUID-EBAB0D5A-3C77-4A9B-9884-3D4AD69E28DC.html["gestion des datastores VMFS dupliqués"] .
