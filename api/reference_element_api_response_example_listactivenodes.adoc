...
summary: 'La méthode ListActiveNodes renvoie une réponse similaire à l"exemple suivant.' 
---
...
[role="lead"]
Le `ListActiveNodes` Cette méthode renvoie une réponse similaire à l'exemple suivant.
