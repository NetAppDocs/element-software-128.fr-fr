...
---
= GetNodeHardwareInfo (sortie pour les nœuds Fibre Channel)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Le `GetNodeHardwareInfo` La méthode pour les nœuds Fibre Channel renvoie une réponse similaire à l'exemple suivant.
