...
summary: 'La méthode GetConfig renvoie une réponse similaire à l"exemple suivant.  En raison de sa longueur, la réponse ne contient d"informations que pour un seul nœud du cluster.' 
---
= GetConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Le `GetConfig` Cette méthode renvoie une réponse similaire à l'exemple suivant.  En raison de sa longueur, la réponse ne contient d'informations que pour un seul nœud du cluster.
