...
NOTE: La méthode AddVirtualNetwork sert uniquement à créer un nouveau réseau virtuel.  Si vous souhaitez apporter des modifications à un réseau virtuel existant, utilisez lexref:reference_element_api_modifyvirtualnetwork.adoc[Modifier le réseau virtuel] méthode.
