...
summary: Vous pouvez utiliser la méthode TestConnectMvip pour tester la connexion de gestion au cluster de stockage.  Le test envoie une requête ping au MVIP et exécute une méthode API simple pour vérifier la connectivité. 
---
= TestConnectMvip
:allow-uri-read: 
:icons: font
...
| VIP | Vous pouvez utiliser cette valeur pour tester la connexion de gestion d'un autre MVIP.  Vous n'avez pas besoin d'utiliser cette valeur lors du test de la connexion au cluster cible. | chaîne | Aucune | Non 
|===
