...
summary: Vous pouvez utiliser la méthode ListISCSISessions pour lister les informations de connexion iSCSI des volumes du cluster. 
---
...
séances
 a| 
Informations relatives à chaque session iSCSI.
 a| 
