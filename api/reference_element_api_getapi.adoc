...
summary: Vous pouvez utiliser la méthode GetAPI pour obtenir la liste de toutes les méthodes API et des points de terminaison API pris en charge qui peuvent être utilisés dans le système. 
---
= GetAPI
:allow-uri-read: 
:icons: font
...
[role="lead"]
Vous pouvez utiliser le `GetAPI` Méthode permettant d'obtenir la liste de toutes les méthodes API et des points de terminaison API pris en charge pouvant être utilisés dans le système.
...
<version>
 a| 
Liste de toutes les méthodes API prises en charge pour cette version du logiciel, où <version> correspond à la version actuelle du logiciel exécutée par ce système.
 a| 
tableau de chaînes
...
Versions prises en charge
 a| 
Liste de tous les points de terminaison d'API pris en charge par le système.
 a| 
tableau de chaînes
