...
summary: 'Vous pouvez utiliser la méthode GetBinAssignmentProperties pour récupérer les propriétés d"affectation des emplacements dans la base de données.' 
---
