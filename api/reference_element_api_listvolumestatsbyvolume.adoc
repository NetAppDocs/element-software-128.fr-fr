...
summary: 'Vous pouvez utiliser la méthode ListVolumeStatsByVolume pour lister les mesures d"activité de haut niveau pour chaque volume, volume par volume.  Les valeurs sont cumulatives depuis la création du volume.' 
---
...
[role="lead"]
Vous pouvez utiliser le `ListVolumeStatsByVolume` méthode pour lister les mesures d'activité de haut niveau pour chaque volume, par volume.  Les valeurs sont cumulatives depuis la création du volume.
