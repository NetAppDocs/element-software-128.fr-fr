...
summary: 'Vous pouvez utiliser la méthode ListActiveAuthSessions pour lister toutes les sessions authentifiées actives.  Seuls les utilisateurs disposant de droits d"accès administratif peuvent appeler cette méthode.' 
---
