...
summary: 'Vous pouvez utiliser la méthode GetVolumeStats pour obtenir des mesures d"activité de haut niveau pour un volume unique.  Les valeurs sont cumulatives depuis la création du volume.' 
---
...
[role="lead"]
Vous pouvez utiliser le `GetVolumeStats` méthode pour obtenir des mesures d'activité de haut niveau pour un seul volume.  Les valeurs sont cumulatives depuis la création du volume.
...
volumeID
 a| 
Spécifie le volume pour lequel les statistiques sont collectées.
 a| 
entier
 a| 
Aucune
...
statistiques de volume
 a| 
Informations sur l'activité du volume.
 a| 
