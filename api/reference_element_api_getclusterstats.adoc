...
summary: 'Vous pouvez utiliser la méthode GetClusterStats pour récupérer des mesures d"activité de haut niveau pour le cluster.  Les valeurs renvoyées sont cumulatives depuis la création du cluster.' 
---
...
[role="lead"]
Vous pouvez utiliser le `GetClusterStats` méthode pour récupérer des mesures d'activité de haut niveau pour le cluster.  Les valeurs renvoyées sont cumulatives depuis la création du cluster.
...
statistiques du cluster
 a| 
Informations sur les activités du cluster.
 a| 
