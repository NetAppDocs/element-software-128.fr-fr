...
summary: 'La méthode ListActiveVolumes renvoie une réponse similaire à l"exemple suivant.' 
---
...
[role="lead"]
Le `ListActiveVolumes` Cette méthode renvoie une réponse similaire à l'exemple suivant.
