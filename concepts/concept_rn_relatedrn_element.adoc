...
summary: 'Vous trouverez des liens vers les notes de version les plus récentes et antérieures pour différents composants de l"environnement de stockage Element.' 
---
= Informations sur les versions actuelles et précédentes
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous trouverez des liens vers les notes de version les plus récentes et antérieures pour différents composants de l'environnement de stockage Element.


NOTE: Vous serez invité à vous connecter à l'aide de vos identifiants de support NetApp .
...
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.182.0.html["Notes de version du module de microprogramme de stockage 2.182.0"^]_NOUVEAU_
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.175.0.html["Notes de version du module complémentaire de microprogramme de stockage 2.175.0"^]
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.164.0.html["Notes de version du module de microprogramme de stockage 2.164.0"^]
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.150.html["Notes de version du module complémentaire de microprogramme de stockage 2.150"^]
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.146.html["Notes de version du module complémentaire de microprogramme de stockage 2.146"^]
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.99.2.html["Notes de version du module complémentaire de firmware de stockage 2.99.2"^]
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.76.html["Notes de version du module complémentaire de microprogramme de stockage 2.76"^]
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.27.html["Notes de version du module complémentaire de microprogramme de stockage 2.27"^]
* https://docs.netapp.com/us-en/hci/docs/rn_H610S_BMC_3.84.07.html["Notes de version du BMC H610S 3.84.07"^]
* https://docs.netapp.com/us-en/hci/docs/firmware_driver_versions.html["Versions de microprogrammes et de pilotes ESXi prises en charge"]_NOUVEAU_
