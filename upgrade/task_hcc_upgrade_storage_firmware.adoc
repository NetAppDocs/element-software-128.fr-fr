...
summary: 'Dans le cadre d"une mise à niveau d"un système NetApp SolidFire , vous mettez à niveau le firmware associé à vos nœuds de stockage.' 
...
IMPORTANT: Pour les nœuds de stockage H610S exécutant la version 12.0 du logiciel Element, vous devez appliquer le correctif D SUST-909 avant de mettre à niveau vers le bundle de firmware de stockage 2.27.  Contactez le support NetApp pour obtenir le correctif D avant de procéder à la mise à niveau. Voirlink:http://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.27.html["Notes de version du module complémentaire de microprogramme de stockage 2.27"^] .
...
* *État du cluster* : Vous avez effectué des contrôles d’état. Voirlink:task_hcc_upgrade_element_prechecks.html["Effectuez des contrôles d'intégrité du stockage Element avant de mettre à niveau le stockage."] .
* *Contrôleur de gestion de carte mère (BMC) mis à jour pour les nœuds H610S* : Vous avez mis à niveau la version du BMC pour vos nœuds H610S. Voirlink:https://docs.netapp.com/us-en/hci/docs/rn_H610S_BMC_3.84.07.html["notes de version et instructions de mise à niveau"^] .



NOTE: Pour obtenir une matrice complète des microprogrammes et des microprogrammes de pilotes pour votre matériel, consultezlink:../hardware/fw_storage_nodes.html["Versions de firmware de stockage prises en charge pour les nœuds de stockage SolidFire"] .
...
.Ce dont vous aurez besoin
* Si votre nœud de gestion n'est pas connecté à Internet, vous avez https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab/download/62654/Storage_Firmware_Bundle["J'ai téléchargé le pack de microprogrammes de stockage"^] .



CAUTION: Pour connaître les problèmes potentiels rencontrés lors de la mise à niveau des clusters de stockage à l'aide de NetApp Hybrid Cloud Control et leurs solutions de contournement, consultez la documentation. https://kb.netapp.com/Advice_and_Troubleshooting/Hybrid_Cloud_Infrastructure/NetApp_HCI/Potential_issues_and_workarounds_when_running_storage_upgrades_using_NetApp_Hybrid_Cloud_Control["Article de la base de connaissances"^] .
...
====
. Sélectionnez la flèche déroulante en regard du cluster que vous mettez à niveau.
...
. Sélectionnez *Micrologiciel uniquement*, puis choisissez parmi les versions de mise à niveau disponibles.
...
| À jour | Le groupe de fonctions a été mis à niveau vers la dernière version Element disponible ou le micrologiciel a été mis à niveau vers la dernière version. 


| Impossible de détecter | Ce statut s'affiche lorsque l'API du service de stockage renvoie un statut de mise à niveau qui ne figure pas dans la liste énumérée des statuts de mise à niveau possibles. 
...
.Étapes
. Téléchargez le package de mise à jour du firmware de stockage sur un périphérique accessible par le nœud de gestion ; accédez au logiciel Element. https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["page de téléchargements"^] et téléchargez la dernière image du firmware de stockage.
. Téléversez le package de mise à jour du firmware de stockage sur le nœud de gestion :
+
...
.. Sélectionnez *Essayer*.
.. Saisissez l'identifiant du package de firmware que vous avez copié à l'étape précédente dans *id*.
...
. Localisez l'identifiant de l'élément d'installation :
+
.. Ouvrez l'interface utilisateur de l'API REST du nœud de gestion sur ce dernier :
+
[listing]
...
. Exécutez la mise à jour du micrologiciel de stockage :
+
